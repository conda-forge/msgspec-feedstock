...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/msgspec-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/msgspec-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add msgspec msgspec-toml msgspec-yaml
# for installing globally
pixi global install msgspec msgspec-toml msgspec-yaml
```
...
It is possible to list all of the versions of `msgspec` available on your platform:
...
```
pixi search msgspec --channel conda-forge
```
